#This file was used for whitebox testing to see how each part of the code Perform
#imported from networkx and modified later
# -*- coding: utf-8 -*-
"""Kernighan_Lin_Bipartition.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1KT04SJ2xbENJHoon1wtcPkIN00tgPORE
"""
...
def _update_delta(delta, G, A, B, u, v, weight,deltatime=0):
...
def _kernighan_lin_pass(G, A, B, weight,deltatime=0):
    ...
    #deltatime += end_compute_delta-start_compute_delta
    swapped = set()
    gains = []
    while len(swapped) < len(G):
        ...
        start_update_delta = time.time()
        delta = _update_delta(delta, G, A - swapped, B - swapped, u, v, weight)
        end_update_delta = time.time()
        deltatime += end_update_delta - start_update_delta
...
def kernighan_lin_bisection(G, partition=None, max_iter=10, weight='weight',
    ...
    for i in range(max_iter):
        ...
        #end = time.time()
        #print( "At ", i, "th pass the time is : " , end-start )
        ...
        B -= bnodes
    big_end = time.time()
    #print( "Total time is : " , big_end-big_start )
    #print("Compute delta takes : ", deltatime )
    #temp = deltatime/(big_end-big_start)
    #print("Which is : " , temp , "th of the whole time")

    return A, B

g = nx.gnm_random_graph(100,150)
a = kernighan_lin_bisection(g)
